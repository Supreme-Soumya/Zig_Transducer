...
#undef CONFIG_EXAM_CONNECT_WIFI
...
#define ESP_ZB_DEFAULT_HOST_CONFIG()                            \
	...
	#define CUSTOM_CLUSTER_ID                   0xFF00  // manufacturer-specific cluster
		#define CUSTOM_ATTR_JSON_ID                 0x0001  // attribute ID for JSON string
		#define CUSTOM_JSON_MAX_LEN                 128     // max JSON string length
